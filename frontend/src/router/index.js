...
const routes = [
    { path: '/login', component: LoginView, meta: { oeffentlich: true } },
    {
        ...
        children: [
            ...
            { path: 'kontakte', component: PlaceholderView, props: { titel: 'Kontakte', text: 'Kontakte und Firmen mit Herkunft, Einwilligungen und Löschvormerkung — in Arbeit (Paket 3).' } },
            { path: 'pipeline', component: PlaceholderView, props: { titel: 'Pipeline', text: 'Deals als Kanban-Board mit Phasen, Wert und Quelle — in Arbeit (Paket 4).' } },
